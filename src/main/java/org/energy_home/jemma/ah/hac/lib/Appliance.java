...
public class Appliance extends BasicAppliance implements IManagedAppliance {
	...
	private class ApplianceManagerImpl extends ApplianceManager {
		 ...
		 */
		public String[] getMatchingClusterTypes(int endPointId, int side, IApplianceDescriptor peerApplianceDescriptor, String peerEndPointType, String[] peerServiceClusterTypes,
				String[] peerClusterListenerTypes) {
