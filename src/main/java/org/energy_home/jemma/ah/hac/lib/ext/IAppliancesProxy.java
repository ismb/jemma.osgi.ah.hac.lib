...
public interface IAppliancesProxy extends IAppliancesBasicProxy, IConfigurationInfoService {
	...
	public abstract ISubscriptionParameters getAttributeSubscription(String appliancePid, Integer endPointId, String clusterName, String attributeName);

	public abstract ISubscriptionParameters setAttributeSubscription(String appliancePid, Integer endPointId, String clusterName, String attributeName,
			ISubscriptionParameters parameters);

	public abstract IAttributeValue getLastNotifiedAttributeValue(String appliancePid, Integer endPointId, String clusterName, String attributeName);
