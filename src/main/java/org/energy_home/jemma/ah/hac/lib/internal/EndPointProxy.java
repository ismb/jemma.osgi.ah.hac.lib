...
public class EndPointProxy extends EndPoint implements IEndPoint {
	...
	public synchronized void addServiceClusterProxy(ServiceClusterProxy serviceClusterProxy) throws ApplianceException {
		...
		IServiceCluster serviceCluster = (IServiceCluster) Proxy.newProxyInstance(clusterIf.getClassLoader(), new Class[] { IServiceCluster.class, IServiceClusterListener.class,
				clusterIf }, serviceClusterProxy);
