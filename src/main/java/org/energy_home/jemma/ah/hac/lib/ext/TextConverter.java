...
public class TextConverter {
	...
	private static void recursiveAppendObject(Object obj, StringBuilder sb) throws IllegalArgumentException, IllegalAccessException {
		...
		if (type.isPrimitive() || type.equals(Boolean.class) || type.equals(Short.class) || type.equals(Integer.class) || type.equals(Long.class) || type.equals(Float.class)
				|| type.equals(Double.class) || type.equals(String.class) || type.equals(Byte.class) || type.equals(byte.class)) {
			sb.append(OBJECT_SEPARATOR);
	...
	public static Object[] getObjectParameters(Class clusterClass, String methodName, String[] params, IEndPointRequestContext context) throws ClassNotFoundException,
