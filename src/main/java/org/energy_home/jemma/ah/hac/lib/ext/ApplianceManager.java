...
public abstract class ApplianceManager implements IApplianceManager {
	...
	public abstract String[] getMatchingClusterTypes(int endPointId, int side, IApplianceDescriptor peerApplianceDescriptor, String peerEndPointType,
			String[] peerServiceClusterTypes, String[] peerClusterListenerTypes);
