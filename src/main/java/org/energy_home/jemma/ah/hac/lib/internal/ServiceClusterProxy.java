...
public class ServiceClusterProxy implements InvocationHandler {
	...
	public ServiceClusterProxy(AppliancesBasicProxy appliancesProxy, Class clusterInterfaceClass, IEndPointRequestContextCheck endPointRequestContextCheck)
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		if (method.getName().equals(GET_END_POINT_CLUSTER_METHOD)) {
			...
			if (endPointRequestContextCheck != null && args != null && args.length > 0 && args[args.length - 1] instanceof IEndPointRequestContext)
				try {
